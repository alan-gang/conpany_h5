...
f7-page.rf_yj_1(:page-content="false")
  ...
  filters(v-if=" sd " @sd=" sd = $event ")
    YJFDP(v-if=" sd === 2 " @stet=" stet = $event " @done=" __setCall({fn: '__closeSD'}) ")
...
import YJFDP from '@/components/filters/YJFDP'
