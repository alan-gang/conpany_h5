              ...
              .hlh_40.mb_5
                .v_m.inlb
                  f7-segmented.w_100(slot="after" )
                    f7-button(round v-for=" (y, j) in rts " :class=" {'color-black bgc_239': x.ruletype !== j} " :active=" x.ruletype === j " @click=" updatert(x, j, i) ") {{ y.n }}
                span.pd_5 ≥
                .wp_30.inlb.v_m
...
export default {
  ...
  props: ['v'],
  data () {
    let r = {ruletype: 0, sales: '', actUser: '', bounsRate: '', sales_: 0, actUser_: 0}
    return {
      is: [
        {n: '每半月', id: 2},
        {n: '每月', id: 1},
