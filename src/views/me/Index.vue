  ...
  .page-content.pt_0
    ...
    .pt_5.pb_5.bg-color-white
      f7-toolbar.ft_12.c_333.bg-color-white(labels)
        ...
        f7-link._icon._xyb(icon-f7=" home " href="/xyb/") 信游宝

    .mg_10
      f7-segmented.bgc_f
        f7-button(:color=" !mycenter ? 'black' : '' " @click=" mycenter = true " :active=" mycenter ") 个人中心
        f7-button(:color=" mycenter ? 'black' : '' " @click=" mycenter = false " :active=" !mycenter ") 代理中心

    .mg_10
      f7-row
        template(v-if=" mycenter ")
          f7-col(width="33")
            f7-button(bg-color="white" color="black" href="/rfs/bc/") 彩票记录
          f7-col(width="33")
        ...
        template(v-else)
          ...
          f7-col(width="33")
            f7-button(bg-color="white" color="black") 下级管理
          f7-col(width="33")
            f7-button(bg-color="white" color="black") 团队报表
    ...
    f7-list.mg_0.no_border(no-hairlines)
      ul.bgc_o
        ...
        template(v-else)
          ...
          f7-list-item.ft_14.bgc_f.mg_10(title="下级游戏记录" link="#")
            f7-icon.mr_5._icon._sub_game_record(slot="media" f7=" home ")

          f7-list-item.ft_14.bgc_f.mg_10(title="下级资金记录" link="#")
