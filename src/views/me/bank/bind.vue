<template lang="pug">
  f7-page.bank_bind
    ...
    f7-list.mg_0(inline-labels no-hairlines ref="_form")
      f7-list-input(:value=" form.n " label="持卡人" placeholder="请输入持卡人姓名" clear-button @change=" form.n = $event.target.value " required)
      ...
      f7-list-input(:value=" form.bn " label="开户支行" placeholder="请输入开户支行" clear-button @change=" form.bn = $event.target.value " required)
